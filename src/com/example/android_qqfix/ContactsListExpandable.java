...
public class ContactsListExpandable extends Activity{
	...
	ArrayList<HashMap<String,Object>> groupItenformation=null; //存放groupItem的相对位置
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter=new MyExpandableListViewAdapter(this,groupData,R.layout.layout_group,groupFrom,groupTo,childData,R.layout.layout_child,childFrom,childTo );
